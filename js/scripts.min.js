...
$(document).ready(function(){
    ...
    // Agregar evento de clic para mostrar/ocultar contenido del mapa
    $('#btn-show-content').on('click', function() {
        var $mapContent = $('#map-content');
        var $mapContentWrapper = $('#map-content-wrapper');
        
        // Alternar la visibilidad del contenido del mapa
        $mapContent.toggleClass('hidden');
        
        // Cambiar el texto del botón según el estado
        if ($mapContent.hasClass('hidden')) {
            $(this).html('<i class="fa fa-info-circle"></i>&nbsp;&nbsp; Show info');
        } else {
            $(this).html('<i class="fa fa-info-circle"></i>&nbsp;&nbsp; Hide info');
        }
    });
});
